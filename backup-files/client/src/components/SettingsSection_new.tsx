    ...
    <Card className="p-4">
      ...
      <div className="pt-4 space-y-6">
        ...
        <Tabs defaultValue="general" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-transparent border-0 p-0 gap-2 h-auto mb-4">
            <TabsTrigger value="general" className="flex items-center justify-center gap-1 border border-border bg-background hover:bg-accent hover:text-accent-foreground font-medium py-2 px-3 rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:border-primary">
              <span className="material-icons text-sm">settings</span>
              <span>General</span>
            </TabsTrigger>
            <TabsTrigger value="branding" className="flex items-center justify-center gap-1 border border-border bg-background hover:bg-accent hover:text-accent-foreground font-medium py-2 px-3 rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:border-primary">
