  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    if (isForgotPasswordMode) {
      ...
      try {
        ...
        setTimeout(() => setIsForgotPasswordMode(false), 3000);
      } catch (err: any) {
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            <div className="space-y-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                  required
                />
              </div>
            </div>
            ...
            >
              {isLoading ? (
                ...
                isForgotPasswordMode ? 'Send Reset Link' : (isLoginMode ? 'Sign In' : 'Sign Up')
              )}
            </Button>
          </form>
